    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'charset' => env('DB_CHARSET', 'utf8mb4'), // utf8mb4 => MySQL v5.5.3 or greater
            'collation' => env('DB_COLLATION', 'utf8mb4_unicode_ci'), // utf8mb4_unicode_ci => MySQL v5.5.3 or greater
